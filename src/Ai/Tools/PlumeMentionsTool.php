...
class PlumeMentionsTool implements Tool
{
    public static function toolId(): string
    {
        return 'plume:mentions';
    }
    ...
    {
        return 'Fetch recent mentions for the authenticated user.';
    }
    ...
    public function handle(Request $request): string
    {
        ...
        try {
            $result = X::mentionsTimeline($userId, $maxResults);
            ...
            return "Error fetching mentions: {$e->getMessage()}";
        }
    }
