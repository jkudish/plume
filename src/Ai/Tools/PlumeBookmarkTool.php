...
class PlumeBookmarkTool implements Tool
{
    public static function toolId(): string
    {
        return 'plume:bookmark';
    }
    ...
    {
        return 'Bookmark a tweet by its ID.';
    }
    ...
    public function handle(Request $request): string
    {
        ...
        try {
            X::bookmark($userId, $tweetId);

            return "Tweet {$tweetId} bookmarked successfully.";
        } catch (Throwable $e) {
            return "Error bookmarking tweet {$tweetId}: {$e->getMessage()}";
        }
    }
