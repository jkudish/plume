...
class PlumeHomeTimelineTool implements Tool
{
    public static function toolId(): string
    {
        return 'plume:home-timeline';
    }
    ...
    {
        return 'Fetch the home timeline for the authenticated user.';
    }
    ...
    public function handle(Request $request): string
    {
        ...
        try {
            $result = X::homeTimeline($userId, $maxResults);
            ...
            return "Error fetching home timeline: {$e->getMessage()}";
        }
    }
