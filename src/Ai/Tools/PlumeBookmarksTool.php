...
class PlumeBookmarksTool implements Tool
{
    public static function toolId(): string
    {
        return 'plume:bookmarks';
    }
    ...
    {
        return 'Fetch the authenticated user\'s bookmarked tweets.';
    }
    ...
    public function handle(Request $request): string
    {
        ...
        try {
            $result = X::bookmarks($userId, $maxResults);
            ...
            return "Error fetching bookmarks: {$e->getMessage()}";
        }
    }
