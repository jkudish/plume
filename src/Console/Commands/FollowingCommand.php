...
class FollowingCommand extends Command
{
    ...
    /** @var string */
    protected $signature = 'plume:following {--max-results=100} {--format=table}';

    /** @var string */
    protected $description = 'List users you are following';
    ...
    public function handle(): int
    {
        ...
        try {
            $users = $client->following($userId, maxResults: (int) $this->option('max-results'));
        } catch (\Throwable $e) {
